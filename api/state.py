...
class OverlayState:
    ...
    def __init__(self):
        ...
        self.pyramids: Optional[Dict] = None
    ...
    def get_visible_collectibles(self, viewport: Dict) -> List[Dict]:
        ...
        # The viewport was detected from cropped screen (top 80%)
        # But we need to scale to full 1920x1080
        scale_x = self.SCREEN_WIDTH / viewport['map_w']
        scale_y = (self.SCREEN_HEIGHT * 0.8) / viewport['map_h']  # Cropped height to map ratio
